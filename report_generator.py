...
<body>
    ...
    def _build_sections(self, grouped: Dict) -> str:
        ...
        section_config = {
            'ioc_based': ('🎯 IOC-Based Threats', 'threat-card'),
            'technique_research': ('🔬 Attack Techniques & Research', 'threat-card technique'),
            'tool_analysis': ('🛠️ Tool Analysis', 'threat-card tool'),
            'threat_actor_profile': ('👤 Threat Actor Intelligence', 'threat-card actor'),
            'vulnerability_analysis': ('🔓 Vulnerability Analysis', 'threat-card'),
            'detection_engineering': ('🔍 Detection Engineering', 'threat-card technique'),
        }
    ...
    def _build_not_actionable_section(self, items: List[Dict]) -> str:
        ...
        <div class="section">
            <div class="section-header">
                <h2>ℹ️ Other Items (Not Actionable)</h2>
            </div>
